export default [
  ...
  { path: '/descriptions', name: 'descriptions', component: '@/views/descriptions/index.vue' },
  { path: '/field-item', name: 'field-item', component: '@/views/field-item/index.vue' },
  { path: '/dialog', name: 'dialog', component: '@/views/dialog/index.vue' },
